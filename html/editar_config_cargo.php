...
$id_cargo = @$_GET['ID_CARGO'];   // IDENTIFICA O ID DO USUARIO, SE ELE EXISTIR ELE ENTRA NA CONDICIONAL "if ($id_chamado)"


if ($id_cargo) {
    $consulta = "SELECT * FROM cargo_autorizacao WHERE ID_CARGO = '$id_cargo'"; // CONSULTA PARA EDITAR 
...
<body>
    ...
    <main class="perfil">
        ...
        <div class="conteiner">
            ...
            <form id="" method="post" action="../php/up_cargo.php">
                ...
                <Section class="edição_usuario">
                    ...
                    <input class="pagina_loguin_input" name="input_cargo" type="text" placeholder="Nome" maxlength="100" value="<?php echo @$linha_input['NOME_CARGO']; ?>" required>
                ...
                <input type="hidden" name="input_id" value="<?php echo @$linha_input['ID_CARGO']; ?>">
