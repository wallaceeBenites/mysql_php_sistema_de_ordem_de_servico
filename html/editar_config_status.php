...
$id_status = @$_GET['ID_STATUS'];   // IDENTIFICA O ID DO USUARIO, SE ELE EXISTIR ELE ENTRA NA CONDICIONAL "if ($id_chamado)"


if ($id_status) {
    $consulta = "SELECT * FROM status WHERE ID_STATUS = '$id_status'"; // CONSULTA PARA EDITAR 
...
<body>
    ...
    <main class="perfil">
        ...
        <div class="conteiner">
            ...
            <form id="" method="post" action="../php/up_status.php">
                ...
                <Section class="edição_usuario">
                    ...
                    <input class="pagina_loguin_input" name="input_status" type="text" placeholder="Nome" maxlength="100" value="<?php echo @$linha_input['NOME_STATUS']; ?>" required>
                ...
                <input type="hidden" name="input_id" value="<?php echo @$linha_input['ID_STATUS']; ?>">
