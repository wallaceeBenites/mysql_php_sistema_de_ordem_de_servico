...
//////////////////////////////////// PARTE RESPONSAVEL PELA EDIÇÃO DA CATEGORIA   ////////////////////////////////////////////////////////////////

$id_categoria = @$_GET['ID_TIPO_SERVICO'];   // IDENTIFICA O ID DO USUARIO, SE ELE EXISTIR ELE ENTRA NA CONDICIONAL "if ($id_chamado)"


if ($id_categoria) {
    $consulta = "SELECT * FROM categoria WHERE ID_TIPO_SERVICO = '$id_categoria'"; // CONSULTA PARA EDITAR 
...
<header class="cabecalho"> <!-- NAVEGADOR CABEÇALHO -->
    ...
    <main class="perfil">
        ...
        <div class="conteiner">
            ...
            <form id="" method="post" action="../php/up_categoria.php">
                ...
                <Section class="edição_usuario">
                    ...
                    <input class="pagina_loguin_input" name="input_categoria" type="text" placeholder="Nome" maxlength="100" value="<?php echo @$linha_input['NOME_AREA_SERVICO']; ?>" required>
                ...
                <input type="hidden" name="input_id" value="<?php echo @$linha_input['ID_TIPO_SERVICO']; ?>">
